...
public class game extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DatabaseReference soundRef = database.getReference("Sound");
    ...
    private void WriteUser() {
        Score score= new Score((hitsCounter-missesCounter),userName,"Easy");
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        DatabaseReference userToAddRef = database.getReference("Score").child("0");
        userToAddRef.child("Score").child("score1");
